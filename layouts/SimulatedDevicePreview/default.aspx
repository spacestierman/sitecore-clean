...
<body>    
    ...
    <script type="text/javascript">     
      ...
      theScreen.onload = function() {                                      
        ...
        //on click event listener - set ribbon unfocused
        theScreen.contentDocument.addEventListener("click", function (sender) {
            window.top.ExperienceEditor.RibbonApp.getApp().setFocused(false);
        }, false);
