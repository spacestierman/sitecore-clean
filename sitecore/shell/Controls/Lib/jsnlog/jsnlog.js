...
(function (JL) {
    ...
    */
    function allow(filters) {
        ...
        if (filters.constructor.name == 'AjaxAppender' && JL.maxMessages && JL.maxMessages < 1) {
          return false;
        }
    ...
    */
        ...
        switch (typeof actualLogObject) {
            ...
            case "object":
                if ((actualLogObject instanceof RegExp) || (actualLogObject instanceof String) || (actualLogObject instanceof Number) || (actualLogObject instanceof Boolean)) {
                  ...
                  return new StringifiedLogObject(null, actualLogObject, JSON.stringify(actualLogObject).replace(/\\n/g, " \\n"));
                }
            default:
    ...
    var AjaxAppender = (function (_super) {
        ...
        AjaxAppender.prototype.sendBatch = function () {
    ...
    var ConsoleAppender = (function (_super) {
        ...
        ConsoleAppender.prototype.sendBatch = function () {
          if (this.batchBuffer.length == 0) {
            return;
          }
...
if (typeof __jsnlog_configure == 'function') {
  ...
  window.onerror = function (errorMsg, url, lineNumber, column, errorObj) {
    ...
    errorObj = errorObj || errorEvent.error || {
      stack: errorMsg + "\n at " + (errorEvent.errorUrl || url) + ":" + (lineNumber || errorEvent.errorLine) + ":" + (column || errorEvent.errorCharacter),
      message: errorMsg
    };

    JL().error(errorMsg, errorObj);
