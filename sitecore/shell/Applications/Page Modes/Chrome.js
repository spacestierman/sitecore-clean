...
Sitecore.PageModes.Chrome = Base.extend({
  ...
  getMaxErrorPriority: function () {
    ...
    for (var e = 0; e < this.data.errors.length; e++) {
      var priority = this.data.errors[e].Priority;
      if (priority == 0) {
        return 0;
      }
  ...
  _clickHandler: function (e) {
    ...
    //when chrome is clicked - setFocused of ribbon to false
    Sitecore.PageModes.PageEditor.ExperienceEditor().RibbonApp.getApp().setFocused(false);
