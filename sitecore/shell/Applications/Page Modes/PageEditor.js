...
Sitecore.PageModes.PageEditor = new function() {
  ...
  */
  this.isAnalyticsEnabled = function () {
    console.log("isAnalyticsEnabled is obsolete, use trackingEnabled instead");
    return !!Sitecore.WebEditSettings.trackingEnabled;
  };

  /**
  * @description Indicates if tracking is enabled
  * @returns {Boolean} The value indicating if tracking is enabled
  */
