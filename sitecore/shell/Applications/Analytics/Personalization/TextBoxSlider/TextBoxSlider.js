...
Sitecore.SliderTextBox = function(id, ctlId, allowOverflow, addPostfix, min, max) {
    ...
    this
        .minOutOfRangeWithConfirmMessage =
    ...
    this
        .maxOutOfRangeWithConfirmMessage =
        "The value you entered is invalid.\nDo you want to extend the range to include this value?";
...
Sitecore.SliderTextBox.prototype.updateSlider = function() {
    ...
    updateText = !((value > this.maxValue) || (value < this.minValue)) ||
    ((parseFloat(slider.get_value()) == this.maxValue) && (parseFloat(sliderData) > this.maxValue)) ||
    ((parseFloat(slider.get_value()) == this.minValue) && (value < this.minValue));
...
Sitecore.SliderTextBox.prototype.validateSliderDataEx = function() {
    ...
    if (value < this.minValue) {
        if (this.allowOverflowValue && value >= 0) {
            if (!confirm(this.formatMessage(this.minOutOfRangeWithConfirmMessage,
            [this.displayName, this.minValue, this.maxValue]))) {
    ...
    if (value > this.maxValue) {
        if (this.allowOverflowValue) {
            if (!confirm(this.formatMessage(this.maxOutOfRangeWithConfirmMessage,
            [this.displayName, this.minValue, this.maxValue]))) {
...
Sitecore.SliderTextBox.prototype.comboboxOnKeyDown = function(e) {
    ...
    ((keyCode <= 40) && (keyCode >= 35)) ||
    ((keyCode <= 46) && (keyCode >= 45)) ||
    (keyCode == 8) ||
    (keyCode == 9) ||
    (keyCode == 38) ||
    (keyCode == 40) ||
    (keyCode == 20) ||
    ((keyCode <= 105) && (keyCode >= 96)) ||
    ((keyCode == 110) && this.AllowDoubleValue))) {
        if (e.preventDefault) {
            e.preventDefault();
        } else {
            e.returnValue = false;
