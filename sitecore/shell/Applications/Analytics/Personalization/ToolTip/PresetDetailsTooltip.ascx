...
<div style="font: normal 8pt tahoma; margin: 15px;">
  <div style="height: 20px; position: relative;">
    <asp:Image runat="server" Style="cursor: pointer; float: right; position: absolute; right: -7px;
               top: -7px;" ID="CloseIcon" />
    <asp:Label runat="server" ID="ProfileNameLabel" Style="font-color: Black; font-weight: bold;" />
  ...
  <div style="border-bottom: 1px solid #eaeaea; border-top: 1px solid #eaeaea; height: 148px; overflow-y: auto;
                           width: 100%;">
    <style type="text/css">
        .row .label {
            color: #909090;
