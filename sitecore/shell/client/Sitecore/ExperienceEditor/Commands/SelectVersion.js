define(
  ...
  Sitecore.Commands.SelectVersion =
  {
    ...
    execute: function (context) {
      ...
      ExperienceEditor.Dialogs.confirm(TranslationUtil.translateTextByServer(TranslationUtil.keys.This_version_does_not_have_a_layout_assigned_Do_you_want_to_open_the_version, ExperienceEditor), function (isOk) {
        if (!isOk) {
          return;
        }
