define(
  ...
  Sitecore.Factories.createBaseComponent({
    ...
    getContextQueryString: function () {
        return "itemId=" + ExperienceEditor.RibbonApp.getApp().currentContext.itemId + "&" +
        "deviceId=" + ExperienceEditor.RibbonApp.getApp().currentContext.deviceId + "&" +
        "database=" + ExperienceEditor.RibbonApp.getApp().currentContext.database + "&" +
