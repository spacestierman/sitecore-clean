...
(function (factory) {
	...
	var methods =
	{
	  ...
	  // SITECORE: Added by ANB -- START ---------------------------------------------
		time2int: function (timeString) {
		  return _time2int(timeString, this.data('timepicker-settings').timeFormat);
		},

		int2time: function (timeInt) {
		  return _int2time(timeInt, this.data('timepicker-settings').timeFormat);
		},

		roundTime: function (time) {
		  _roundTime(time, this.data('timepicker-settings'));
		},

	  // SITECORE: Added by ANB -- END ---------------------------------------------
