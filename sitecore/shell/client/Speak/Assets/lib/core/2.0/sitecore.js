...
var isBrowser = typeof window !== "undefined", root = isBrowser ? window : global, isInitialized = root.__SPEAK_LOADED, config = root.__speak_config || {}, cultureConfig = root.__speak_config_culture || [], activeCulture = root.__speak_config_active_culture;
...
speak.globalize = new index_5.SpeakGlobalize(root.Globalize, cultureConfig, activeCulture);
/**
...
exports.type = type;
},{"./ises/empty":70,"./ises/guid":71,"./ises/nullorundefined":72,"./ises/type":73}],70:[function(require,module,exports){
...
},{"../type":74}],71:[function(require,module,exports){
var guid = require( "sc-guid" );

module.exports = function ( value ) {
  return guid.isValid( value );
};
},{"sc-guid":68}],72:[function(require,module,exports){
module.exports = function ( value ) {
...
},{"../type":74}],74:[function(require,module,exports){
var toString = Object.prototype.toString;
...
},{"./utils/array":76,"./utils/async":77,"./utils/date":78,"./utils/function":79,"./utils/is":80,"./utils/object":82,"./utils/string":83,"./utils/url":84,"sc-is":69}],76:[function(require,module,exports){
var is = require( "sc-is" );
...
},{"sc-is":69}],77:[function(require,module,exports){
...
module.exports = is;
},{"sc-is":69}],81:[function(require,module,exports){
var arrayProto = Array.prototype;
