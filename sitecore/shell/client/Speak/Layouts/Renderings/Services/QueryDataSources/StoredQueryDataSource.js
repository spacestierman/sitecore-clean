...
define(["sitecore", "itemService"], function (sc, itemService) {
    "use strict";
...
// TODO           this.model.set("language", this.$el.attr("data-sc-language"));
    ...
    sc.Factories.createComponent("StoredQueryDataSource", model, view, "script[type='text/x-sitecore-storedquerydatasource']");
});