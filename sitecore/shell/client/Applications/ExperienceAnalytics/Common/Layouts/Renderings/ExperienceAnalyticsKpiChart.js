require.config({
    paths: {
        ...
        experienceAnalyticsMetricsFormatter:
            "/sitecore/shell/client/Applications/ExperienceAnalytics/Common/Layouts/Renderings/Shared/ExperienceAnalyticsMetricsFormatter"
    }
});

define(["sitecore", "experienceAnalyticsD3ChartBase", "experienceAnalyticsMetricsFormatter"],
    function(sitecore, experienceAnalyticsD3ChartBase, metricsFormatter) {
        ...
        sitecore.Factories.createBaseComponent({
            ...
            afterRender: function() {
                ...
                _(this.chartModel.viewModel)
                    .extend({ toggleProgressIndicator: this.toggleProgressIndicator.bind(this) });
            ...
            setChartData: function(data) {
                ...
                _(dynamicData)
                    .each(function(dataPoint) {
                            ...
                            var metricValue = metricsFormatter
                                .getFormattedString(dataPoint.metricValue,
                                    dataPoint.numberScale.name,
                                    dataPoint.numberScale.scaleUnit,
                                    dataPoint.numberScale.scaleValue);
