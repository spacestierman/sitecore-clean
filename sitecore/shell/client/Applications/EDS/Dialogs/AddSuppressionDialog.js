    ...
    function(sitecore, edsUtil) {
        return sitecore.Definitions.App.extend({
            ...
            submitAction: function() {
                ...
                if (!edsUtil.emailIsValid(email)) {
                    ...
                    this.MessageBar.addMessage("error",
                        sitecore.Resources.Dictionary.translate("EDS.Validation.EmailAddressNotValid"));
                    return;
                }
                ...
                if (contextItem.isValid()) {
                        ...
                        .fail(function(error) {
                            ...
                            if (errorMessage.length > 0 && errorMessage !== "Operation failed.") {
                                ...
                                message = sitecore.Resources.Dictionary
                                    .translate("EDS.Notifications.EmailAddressHasNotBeenAddedToSuppression") +
                                    " " +
                    ...
                    this.EmailTextBox.viewModel.focus();
                    this.MessageBar.addMessage("error",
                        sitecore.Resources.Dictionary.translate("EDS.Validation.ValidationFailed"));
                }
            },
            ...
            trackChanges: function() {
                this.EmailTextBox.viewModel.$el.on("cut input paste keyup",
