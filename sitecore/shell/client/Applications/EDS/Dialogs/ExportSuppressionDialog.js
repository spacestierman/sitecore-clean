define(["sitecore", "/-/speak/v1/EDS/fileDownloader.js", "/-/speak/v1/EDS/edsUtil.js"],
    function(sitecore, fileDownloader, edsUtil) {
        return sitecore.Definitions.App.extend({
            ...
            submitAction: function() {
                ...
                if (options.isDateRange) {
                    ...
                    if (startDate && endDate && startDate > endDate) {
                        this.MessageBar.addMessage('error',
                            sitecore.Resources.Dictionary
                            .translate("EDS.Validation.TheEndDateMustBeLaterThanStartDate"));
                        return;
                    }
                ...
                fileDownloader.download("/sitecore/api/ssc/EDS/ExportSuppression",
                    options,
            ...
            downloadInProgress: function(options) {
                if (!this.downloadCompleted) {
                    ...
                    message.text = sitecore.Resources.Dictionary.translate("EDS.Notifications.TheListIsBeingExported");
            ...
            downloadError: function(options, cookieValue) {
                ...
                var message = {
                    ...
                    actions: [
                        {
                            text: sitecore.Resources.Dictionary.translate("EDS.TryAgain"),
                            action: "trigger:suppression:export({\"exportOptions\":" + JSON.stringify(options) + "})"
                        }
                    ],
                    closable: false
                };
                ...
                if (cookieValue.toLowerCase() === "true") {
                    message.text = sitecore.Resources.Dictionary.translate("EDS.Validation.TheDateRangeIsInvalid");
                } else {
                    message.text = sitecore.Resources.Dictionary
                        .translate("EDS.Notifications.AnErrorOccurredListWasNotExported") +
                        " " +
                        sitecore.Resources.Dictionary.translate("EDS.CheckTheLogFileForDetails");
                }
            ...
            removeMessages: function(token) {
                token = token || "";
                this.contextApp.MessageBar.removeMessage(function(oldMessage) {
                    return oldMessage.id === "exportinprogress" + token;
                });
                this.contextApp.MessageBar.removeMessage(function(oldMessage) {
                    return oldMessage.id === "exporterror" + token;
                });
            },
