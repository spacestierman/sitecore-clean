(function() {
    ...
    define(dependencies,
        function(sitecore) {
            ...
            return {
                init: function(app) {
                    app.insertRendering("{43D7456E-C098-4F42-8805-7D905BA283D9}",
                        { $el: $("body") },
                        function(showSelectContactListDialog) {
                ...
                SelectContactListByExistingListId: function(callback, excludelists, existingListId) {
                    ...
                    sitecore.trigger("select:contactlists:dialog:show",
                        completed,
                        excludelists,
                        existingListId,
                        contactListsFilter);
                ...
                SelectContactListForNewList: function(callback, excludelists) {
                    ...
                    sitecore
                        .trigger("select:contactlists:dialog:show", completed, excludelists, "", contactListsFilter);
                },
