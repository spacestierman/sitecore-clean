        ...
        validateTestLength: function () {
            ...
            if (!isEstimated) { // If not enough traffic to do forecasting
                ...
                if (daysExpected > maxDurationValue) { // If test will take too long
                    ...
                    templateFirstMessage = _.template(
            	      this.StringDictionary.get("In this test, there are <%= experiences %> experiences.") + " " +
	 	    ...
	 	    this.StringDictionary.get("It is possible to run the test but to find a winner it will require a large number of visitors. To reduce the number of visitors needed, you can reduce the number of variations."));
