        ...
        SelectItemDialog: function (options) {
            ...
            var ob = {
                ...
                setSelectedItemFromList: function () {
                    ...
                    var uri = "sitecore://" + itemId + "?ver=&lang=";

                    var selectedItem = this._hostPage.ResultsList.get("selectedItem");
                    var templateId = selectedItem != undefined ? selectedItem.get("$templateId") : null;
                    ...
                    this._hostPage.set(this._itemUriPropertyName, uri);
                    this._hostPage.set(this._itemTemplateIdPropertyName, templateId);
