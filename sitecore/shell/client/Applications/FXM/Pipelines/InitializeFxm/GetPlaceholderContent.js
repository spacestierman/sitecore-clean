define([
  ...
  return {
    execute: function (context) {
      ...
      _plUtils.serverPromiseProcessor(url, context, { ItemId: context.currentContext.itemId, ids: placeholderIdList, database: context.currentContext.database, language: context.currentContext.language }, success);
    }
  }
});