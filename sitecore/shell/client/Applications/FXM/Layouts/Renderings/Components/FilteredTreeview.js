...
define(['sitecore', 'dynatree'], function (_sc) {
  ...
  var control = {
    ...
    [
      ...
      { name: "templatesWhiteList", added: true },
    ...
    view:
    {
      initialized: function () {
        ...
        var clickFolderModeAttribute = this.$el.attr("data-sc-option-clickfoldermode"),
          ...
          templatesWhiteListAttribute = this.$el.attr("data-sc-templateswhitelist");
        ...
        if (templatesWhiteListAttribute === '*') {
          this.model.set("templateswhitelist", templatesWhiteListAttribute);
        } else {
          this.model.set("templateswhitelist", templatesWhiteListAttribute ? templatesWhiteListAttribute.split('|') : []);
        }
      ...
      nodeExpanding: function (node) {
        ...
        database.getChildren(itemUri.getItemId(), function (items) {
          ...
          var templatesWhiteList = self.model.get("templateswhitelist");
          if (templatesWhiteList != '*') {
            filteredItems = _.reject(filteredItems, function(childItem) {
              return !_.contains(templatesWhiteList, childItem.$templateId);
            });
          }
