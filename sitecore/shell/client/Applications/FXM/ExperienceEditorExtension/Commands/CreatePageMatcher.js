define(["sitecore", "/-/speak/v1/ExperienceEditor/ExperienceEditor.js", "/-/speak/v1/FXM/ComponentSettings.js"], function (_sc, ExperienceEditor, componentSettings) {
  ...
  _sc.Commands.CreatePageMatcher =
  {
    ...
    execute: function (context) {
      ...
      var dialogPath = "/sitecore/client/Applications/FXM/ExperienceEditorExtension/Dialogs/CreatePageMatcher?itemId=" + itemId + "&" + urlQueryParamater + "=" + selectedUrl + "&lang=" + context.currentContext.language;
