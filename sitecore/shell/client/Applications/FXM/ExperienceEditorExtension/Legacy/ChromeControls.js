define([
...
], function (_scl, $sc, _fxm, TranslationUtil, ExperienceEditor) {
    ...
    function renderExpandCommand() {
        if (_fxm.isSelector(this.chrome.type.key())) {
            ...
            var displayName = TranslationUtil.translateTextByServer("You cannot select parent. It may contain other controls.", ExperienceEditor);
