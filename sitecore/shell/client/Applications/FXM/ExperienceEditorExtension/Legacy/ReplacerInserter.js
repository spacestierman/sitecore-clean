                ...
                this.addTarget('top',
                    ...
                    beforeKey,
                    {
                        tooltip: TranslationUtil
                            .translateTextByServer("Add a new placeholder before the element", ExperienceEditor),
                        header: TranslationUtil.translateTextByServer("Add before", ExperienceEditor)
                    });

                this.addTarget('middle',
                    this.placeholder,
                    replaceKey,
                    {
                        tooltip: TranslationUtil.translateTextByServer("Add a new placeholder instead of the element",
                            ExperienceEditor),
                        header: TranslationUtil.translateTextByServer("Replace", ExperienceEditor)
                    });

                this.addTarget('after',
                    this.placeholder,
                    afterKey,
                    {
                        tooltip: TranslationUtil
                            .translateTextByServer("Add a new placeholder after the element", ExperienceEditor),
                        header: TranslationUtil.translateTextByServer("Add after", ExperienceEditor)
                    });
