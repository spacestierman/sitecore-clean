define(["sitecore"], function (sitecore) {
  var model = sitecore.Definitions.Models.ControlModel.extend({
    ...
    getRecipients: function (recipientListIds, lastRecipientListId, lastRecipientIndex) {
      ...
      var data = { messageId: this.get("messageId"), lastRequestGuid : this.lastRequestGuid, recipientListIds: recipientListIds, lastRecipientListId: lastRecipientListId, lastRecipientIndex: lastRecipientIndex, pageSize: this.get("recipientPageSize"), search: this.get("search") };
      var options = {
