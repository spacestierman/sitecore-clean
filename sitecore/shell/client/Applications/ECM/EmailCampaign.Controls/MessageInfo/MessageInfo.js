define([
    ...
    var model = sitecore.Definitions.Models.ControlModel.extend({
        ...
        refresh: function(messageContext) {
            ...
            ServerRequest(Constants.ServerRequests.MESSAGE_INFO, {
                data: { messageId: this.get("messageId"), language: language },
    ...
    var view = sitecore.Definitions.Views.ControlView.extend({
        ...
        redraw: function (data) {
            ...
            if (MessageService.messageContext.get('totalRecipients') !== data[3].Value) {
                MessageService.messageContext.set('totalRecipients', data[3].Value);
            }
