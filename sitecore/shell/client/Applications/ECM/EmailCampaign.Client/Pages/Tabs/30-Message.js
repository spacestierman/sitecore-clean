    ...
    function(
        ...
        var messageTab = sitecore.Definitions.App.extend({
            ...
            initialized: function() {
                ...
                this.isAutomated = this.MessageContext.get('messageType') === constants.MessageTypes.AUTOMATED;
                ...
                var abTestingNotAutomatedNotSubscriptionHTML = this.isAbTesting &&
                    !this.isSubscriptionFromHTML &&
                    !this.isAutomated;
                this.variantActionsState = {
                    remove: abTestingNotAutomatedNotSubscriptionHTML,
                    duplicate: abTestingNotAutomatedNotSubscriptionHTML,
                    abTestingResults: abTestingNotAutomatedNotSubscriptionHTML,
                    add: abTestingNotAutomatedNotSubscriptionHTML && !this.isExistingPageBased,
                    insertToken: true,
