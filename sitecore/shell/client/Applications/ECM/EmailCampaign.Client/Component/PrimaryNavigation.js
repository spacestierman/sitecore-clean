define([
  ...
  return {
    initializePrimaryNavigation: function(app) {
      ...
      contextApp.on({
        'create:regularmessage': function () {
          self.clickCreateButton();
          DialogService.show("createRegularMessage", { data: self.getMessageCreationContext(contextApp) });
        },
        'create:automatedmessage': function () {
          self.clickCreateButton();
          DialogService.show("createAutomatedMessage", { data: self.getMessageCreationContext(contextApp) });
        },
