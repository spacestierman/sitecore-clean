define(["sitecore", "/-/speak/v1/ecm/NumericInputValidation.js", "/-/speak/v1/ecm/ComboBoxDataSource.js"], function (sitecore, validation, comboBoxDataSource) {
    var datePickers = ["ScheduleRecurringDateDatePicker", "ScheduleRecurringEndByDateColumnPanelDatePicker"];
    ...
    fixStartDates: function () {
        _.each(datePickers, _.bind(function (datePickerName) {
            var datePickerEl = $(this.ScopedEl).find('[data-sc-id=' + datePickerName + ']');
            if (datePickerEl.length && datePickerEl.datepicker && !datePickerEl.datepicker("option", "minDate")) {
                datePickerEl.datepicker("option", "minDate", 0);
            }
        }, this));
    }
  });
