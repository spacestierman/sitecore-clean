            ...
            ServerRequest(Constants.ServerRequests.IMPORT_HTML, {
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        response.notificationEvent = "importHtmlLayoutFailed";
                        sitecore.trigger('importHtmlLayout:error', { id: "importHtmlLayoutFailed", text: response.errorMessage, actions: [], closable: true });
                        return;
                    }
                ...
                error: function () {
                    console.log('something went wrong here2');
                },
                async: false
            });
        }
