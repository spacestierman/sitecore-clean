define([
    ...
    return DialogBase.extend({
        ...
        addAttachment: function(file) {
            ...
            $("[data-sc-id='UploaderInfo']").find("img[src*='" + file.image + "']").closest('div[class="sc-uploaderInfo-row"]').remove();
            if ($("div.sc-uploaderInfo-row").length < 1) {
                this.Ok.set("isEnabled", false);
                this.Uploader.set('hasFilesToUpload', false);
            }
        },
        ...
        showDialog: function(options) {
            ...
            if (!this.Uploader.get('hasFilesToUpload')) {
                this.Uploader.viewModel.updateUploadInfo();
            }
        },
