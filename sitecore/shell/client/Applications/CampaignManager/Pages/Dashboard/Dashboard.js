        ...
        var dashboardDefinition = {
            ...
            initialized: function() {
                ...
                this.on("cm:campaign:experience",
                    function() { this.CampaignExecutionSubAppRenderer.gotoExperienceAnalytics(); },
                    this);
                ...
                this.CampaignDataSource.on("change:url change:classifications",
            ...
            campaignInfoSubAppRendererInitialized: function() {
                this.CampaignInfoSubAppRenderer.GeneralInformationNameValue
                    .set('watermark', this.StringDictionary.get(dictionary.FilterByCampaignName));
            },
            ...
            updateSmartPanelData: function() {
                ...
                if ((typeof model !== "undefined") && (model !== null)) {
                    ...
                    if (typeof this.CampaignExecutionSubAppRenderer !== "undefined") {
                        ...
                        this.CampaignExecutionSubAppRenderer
                            .setEngagementPlan({
                                Id: model.get("EngagementPlan"),
                                Title: model
                                    .get("EngagementPlanTitles")
                            });
