        ...
        var isoMinDate = "10101T000000",
            ...
            campaignDefinition = {
                ...
                initialized: function() {
                    ...
                    this.on("cm:campaign:experience",
                        function() { this.ExecutionSubAppRenderer.gotoExperienceAnalytics(); },
                        this);
                ...
                updateTaskPageData: function(model) {
                    ...
                    if (typeof model !== "undefined" && model !== null) {
                        ...
                        if (typeof this.CampaignClassifications !== "undefined" &&
                            typeof model.Classifications !== "undefined") {
                        ...
                        if (typeof this.ExecutionSubAppRenderer !== "undefined") {
                            ...
                            this.ExecutionSubAppRenderer
                                .setEngagementPlan({ Id: model.EngagementPlan, Title: model.EngagementPlanTitles });
                    ...
                    if ((this.uninitializedSubAppRenderersCount === 0) &&
                    ((this.EntityDataSource.get('isBusy') !== true) ||
                        (urlParser.getParameterFromLocationSearchByName(constants.IdQueryKey) === ""))) {
                ...
                showAnalyticsWarning: function() {
                    if (this.isAnalyticsDisabled === true) {
                        var text = this.StringDictionary.get(dictionary
                ...
                deleteCampaignOk: function() {
                    ...
                    promise.then(self.deleteSuccess,
                        function(er) {
                ...
                deleteSuccess: function() {
                    location.href = constants.DashboardPath +
                        "?" +
                        constants.ActionQueryKey +
                        "=" +
                        constants.CampaignDeletedQueryValue;
                },
                // ***UTILS***
                ...
                updateStoredState: function(model) {
                    ...
                    if (typeof model.Classifications === "undefined" ||
                        model.Classifications === null ||
                        model.Classifications === "") {
                        viewModel.stored.Classifications = {};
                    }
                    var isoStartDate = sitecore.Helpers.date.toISO(model.StartDate);
                    if (typeof isoStartDate !== "undefined" &&
                        isoStartDate !== null &&
                        isoStartDate.indexOf(isoMinDate) !== -1) {
                        viewModel.stored.StartDate = "";
                    }
                    var isoEndDate = sitecore.Helpers.date.toISO(model.EndDate);
                    if (typeof isoEndDate !== "undefined" &&
                        isoEndDate !== null &&
                        isoEndDate.indexOf(isoMinDate) !== -1) {
