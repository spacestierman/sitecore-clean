define(['sitecore', '/-/speak/v1/campaignmanager/dictionary.js'],
    function(sitecore, dictionary) {
        "use strict";
        // Constants
        ...
        var extensionObject = {
            ...
            getValidationErrorMessage: function() {
                ...
                if ((typeof startDate === 'undefined') || (startDate === null) || (startDate === '')) {
                    ...
                    if (this.GeneralInformationStartDateValue.viewModel
                        .convertDate(startDate,
                            this.GeneralInformationStartDateValue.get('dateFormat')
                            .replace(/yy/g, 'y')) !=
                        this.GeneralInformationStartDateValue.get('formattedDate')) {
                ...
                if ((typeof endDate === 'undefined') || (endDate === null) || (endDate === '')) {
                    ...
                    if (this.GeneralInformationEndDateValue.viewModel
                        .convertDate(endDate,
                            this.GeneralInformationEndDateValue.get('dateFormat')
                            .replace(/yy/g, 'y')) !=
                        this.GeneralInformationEndDateValue.get('formattedDate')) {
