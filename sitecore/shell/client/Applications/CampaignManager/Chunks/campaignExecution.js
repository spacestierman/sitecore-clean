        ...
        return sitecore.Definitions.App.extend({
            initialized: function() {
                if (typeof this.CampaignExecutionPlanEditor !== "undefined") {
                    this.CampaignExecutionPlanEditor.on("change:value",
                        function() {
                            sitecore.trigger('cm:execution:plan:changed');
                        },
                        this);
                    this.CampaignExecutionPlanEditor.on("change:friendlyValue",
                        function(control, friendlyValue) {
                            this.CampaignExecutionPlanValue.set("text", friendlyValue);
                        },
                        this);
                }
                this.on("treeListExEditor:close",
                    function() {
            ...
            setEngagementPlan: function(value) {
                if (typeof this.CampaignExecutionPlanEditor === "undefined") {
                    this.CampaignExecutionPlanValue.set("text",
                        typeof value !== "undefined" && value !== null ? value.Title : '');
                } else {
                    this.CampaignExecutionPlanEditor.set('value',
                        typeof value !== "undefined" && value !== null ? value.Id : '');
                    this.CampaignExecutionPlanEditor.set('friendlyValue',
                        typeof value !== "undefined" && value !== null ? value.Title : '');
                    sitecore.trigger('cm:execution:plan:changed');
                }
            },
