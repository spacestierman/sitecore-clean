define(['jquery', 'sitecore', '/-/speak/v1/client/entityservice.js'],
    function(jQuery, sitecore, EntityService) {
        "use strict";
        return {
            ...
            getDecoratorFor: function(obj) {
                ...
                if (typeof obj.execute !== 'undefined') {
                    jQuery.extend(result,
                    {
                        ...
                        refresh: function() {
                            this.Service = this
                                .getEntityServiceInstance(jQuery
                                    .extend({ url: this.get('serviceURL') }, self.getSettings()));
