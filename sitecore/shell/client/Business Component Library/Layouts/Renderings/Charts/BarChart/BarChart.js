require.config({
  paths: {
    ...
    bar: "/sitecore/shell/client/Business Component Library/Layouts/Renderings/Charts/D3/Components/Bar",
...
define(["sitecore", "css!nvd3Style", "d3", "nvd3", "nvd3Models", "formatterConfig", "bar"], function (Sitecore) {

  Sitecore.Factories.createBaseComponent({
    name: "BarChart",
    base: "ControlBase",
    selector: ".sc-d3-barchart",
    attributes: [
      ...
      { name: "isValueShownOnBar", value: '$el.data:sc-isvalueshownonbar' },
    ...
    initialize: function () {
      ...
      var options = {
        ...
        isValueShownOnBar: this.model.get('IsValueShownOnBar'),
      ...
      this.ChartComponent = new Sitecore.D3.components.Bar(options);
