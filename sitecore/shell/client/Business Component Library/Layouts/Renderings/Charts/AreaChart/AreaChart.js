require.config({
  paths: {
    ...
    area: "/sitecore/shell/client/Business Component Library/Layouts/Renderings/Charts/D3/Components/Area",
  ...
  shim: {
    ...
    "area": { deps: ["nvd3Models"] }
  }
});

define(["sitecore", "css!nvd3Style", "d3", "nvd3", "nvd3Models", "formatterConfig", "area"], function (Sitecore) {

  Sitecore.Factories.createBaseComponent({
    name: "AreaChart",
    base: "ControlBase",
    selector: ".sc-d3-areachart",
    attributes: [
      ...
      { name: "seriesStyle", value: '$el.data:sc-seriesstyle' },
    ...
    initialize: function () {
      ...
      var options = {
        ...
        seriesStyle: this.model.get("seriesStyle"),
      ...
      this.ChartComponent = new Sitecore.D3.components.Area(options);
