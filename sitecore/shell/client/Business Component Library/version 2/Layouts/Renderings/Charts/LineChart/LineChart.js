(function (speak) {
  ...
  speak.component(["sitecore", "css!bclNvd3Style", "d3", "nvd3", "bclNvd3Models", "bclLine"], function (Speak) {
    ...
    return {
      ...
      initialized: function () {
        ...
        var options = {
          ...
          isAreaUnderLineFilled: this.IsAreaUnderLineFilled,
        ...
        this.ChartComponent = new Sitecore.Speak.D3.components.Line(options);
