...
$(document).ready(function(){
  ...
  var showConfirmDialog = function(btnName) {
      $("#dialog-confirm").dialog({
          ...
          buttons: {
              ...
              "Yes": function () {
                  $(this).dialog("close");
                  __doPostBack(btnName ? btnName : "btnNext", "");
              }
          }
      });
...
<div style="margin: 2em 0 1em 0;" id="InformationPanel" runat="server">
   <p id="lblInformation" runat="server">
    ...
    <span id="DownloadBCPanel" runat="server" align="right" style="float: right;">
        <asp:LinkButton ID="DownloadBCButton" Visible="False" runat="server" Text=""
            OnClick="DownloadBreakingChangesReport" />
    </span> <br/>
</div>
...
<div id="dialog-confirm" title="Warning">
    <table>
        <tr>
            ...
            <td>
                <div>
                    <span id="text-warning">Custom assemblies are affected by Breaking Changes.<br />
                         Are you sure you want to continue without unloading them?</span>
                </div>
            </td>
        </tr>
    </table>
