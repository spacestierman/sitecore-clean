        ...
        <asp:Panel runat="server" ID="ConflictDetailsWrapper">
            ...
            <div class="expandable">
                ...
                <div class="expandable-content">
                    <div>
                        <input type="radio" name="DisplayOptions" checked id="ContextSizeRadio" class="expandable-content-number" value="false" />
            ...
            <div>
                <asp:HyperLink NavigateUrl="~/sitecore/admin/Wizard/ConfigurationDiffSideBySide.aspx" Target="_blank" runat="server"> Show side-by-side diff</asp:HyperLink>
            </div>
